...
export const ROAK_PRINCIPLES: Principle[] = [
  {
    ...
    m3Equivalent: 'Material Trust & Feedback',
    m3Detail: 'M3 关注系统的反馈和控制。虽然没有专门针对“车辆工业安全”的原则，但 M3 的 Error/Critical 颜色系统和无障碍（A11y）准则确保了信息能够清晰地传达给用户。',
  ...
  },
  {
    ...
    roakDetail: '使用用户熟悉的传统 UI 交互模式。严禁为创新而创新，例如：不要制造复杂的非标准滑块，使用经典下拉框、多选框和简洁的卡片面板。',
    m3Equivalent: 'Standardized Systems',
    m3Detail: 'M3 提供了极其完整和一致的标准化组件库（按钮、文本框、卡片、导航），旨在减少用户的认知负荷，让交互变得可预测。',
    safetyRating: 'critical',
    iconName: 'Sparkles'
  },
  {
    ...
    m3Equivalent: 'Expressive Architecture',
    m3Detail: 'M3 的透明性偏向于系统设计和个性化。通过清晰的视觉层级和状态指示器（State layers）向用户传达当前是什么组件在交互、处于什么状态。',
    safetyRating: 'high',
    iconName: 'Eye'
  },
  {
    ...
    description: '系统的公众形象。糟糕的 UI 和 UX 印象将导致对整个系统的不信任。UI 应精致而非粗糙。Mobius 应呈现简化的现实视图，移除用户完成任务所不需要的一切。',
    roakDetail: '每一个对齐、间距、像素和动画都有其含义。剔除任何多余的装饰，杜绝“科技黑话”（Tech-Larping），如无意义的日志流、坐标跳动或炫酷但多余的 3D 线框。保持纯粹的 2D 精美渲染。',
    m3Equivalent: 'Craftsmanship & Polishing',
    m3Detail: 'M3 通过细腻的动态过渡效果（Spring animations）、精密计算的圆角（Shapes 8dp - 28dp）以及精细的颜色灰度层级，展现了极高的视觉工艺水平。',
    safetyRating: 'high',
    iconName: 'Compass'
  },
  {
    ...
    m3Equivalent: 'Adaptive Design',
    m3Detail: 'M3 引领了跨屏幕尺寸设计的先河。它的组件支持从手机、折叠屏到平板和桌面的自适应布局（Adaptive Columns and Rails），非常注重弹性扩张。',
    safetyRating: 'medium',
    iconName: 'TrendingUp'
  },
  {
    id: 'humility',
    name: 'Humility (谦逊)',
    description: 'UI 应为特定的基于任务的使用场景而设计。不同市场细分领域的用户没有共同体验。他们不应共享共同的 UI。Mobius UI 应自我解释。不要假设用户了解系统的任何信息。UI 和交互模型应在整个应用中保持一致。',
    roakDetail: '不要强迫港口操作员、矿场指挥官和物流调度员共用一套高度复杂、通用的全能界面。根据他们的任务，提炼核心工具。保持所有按钮的外观和交互一律一致，杜绝惊喜。',
    m3Equivalent: 'User-Centric / Personalization',
    m3Detail: 'M3 提倡“Material You”，将控制权交还给用户，允许根据其偏好、壁纸提取色调来动态定制专属界面。它通过极致的包容性尊重不同的用户群体。',
    safetyRating: 'medium',
    iconName: 'Users'
  }
];
